...
//  * ==========================================================================
//  * MODELO DE DATOS INICIALES (Simulación de BBDD)
//  * ==========================================================================
//  */

// Datos de productos con descuentos simulados
const initialProducts = [
    { id: 1, name: "Drone Plegable X500", category: "Drones", price: 350.00, discount: 50.00, features: "Cámara 4K, 30 min de vuelo, GPS", image: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse2.mm.bing.net%2Fth%2Fid%2FOIP.iFnSgTCYuWvqHegctL0u6gHaGX%3Fpid%3DApi&f=1&ipt=00550bd57b52a225feff0ae41da13e123e72eb76c235e3edef324dff6ed36296&ipo=images" },
    { id: 2, name: "Smartwatch Elite 9", category: "Wearables", price: 199.99, discount: 0.00, features: "Monitor de salud avanzado, 7 días de batería", image: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse3.mm.bing.net%2Fth%2Fid%2FOIP.OG4FOoVJKTdivZ_0sY1SlQHaER%3Fpid%3DApi&f=1&ipt=404b196fcf9efacc5aeb92a4caa17b1798501859ce9f6b504563470b1ffeb4ce&ipo=images" },
    { id: 3, name: "Auriculares Inalámbricos Pro", category: "Audio", price: 120.00, discount: 30.00, features: "Cancelación de ruido activa, 24 horas de autonomía", image: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%2Fid%2FOIP.pfl6U-fgl3gc70M5vGkJtwHaHa%3Fpid%3DApi&f=1&ipt=a7ac2225ecd9fb10200821ddcd90dfea3cd797560f504786bbb6c4e9cb66f3ce&ipo=images" },
    { id: 4, name: "Teclado Mecánico RGB", category: "Accesorios", price: 85.50, discount: 0.00, features: "Switches táctiles, Iluminación RGB personalizable", image: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse3.mm.bing.net%2Fth%2Fid%2FOIP.kVScZRqecUfTLZErno9VGwHaD7%3Fpid%3DApi&f=1&ipt=4be036f748c93217a61619bb64ccfafe6835983826108d0322721892e5ccbb13&ipo=images" },
    ...
    { id: 6, name: "Cámara Réflex Digital S1", category: "Fotografía", price: 750.00, discount: 100.00, features: "24MP, Video 4K, Lente 18-55mm incluida", image: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%2Fid%2FOIP.bwmoEK3NHhkm1VdHmpmE9AHaHa%3Fpid%3DApi&f=1&ipt=5fc0a2beca21e18dc9ea6f90492cef0ea0502c25c7671f9762049135de15e0b2&ipo=images" },
];
...
let productRequests = JSON.parse(localStorage.getItem('productRequests')) || []; // Para la simulación de encargos/solicitudes
...
function renderProductList(productArray, containerId) {
    ...
    container.innerHTML = productArray.map((product, index) => {
        // Añade un retraso en la animación de carga (cardLoad)
...
/**
 * ==========================================================================
 * LÓGICA DEL CARRUSEL Y ANIMACIONES
 * ==========================================================================
 */

const heroImages = [
    { url: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%2Fid%2FOIP.C-kDG7QV7FLokGQECi-jEAHaDt%3Fpid%3DApi&f=1&ipt=bdd1312d06bc134c9498f4d4953bd7a0c79edd42010215964e3e2a1a9588caaa&ipo=images", alt: "Tecnología de Vanguardia" },
    { url: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%2Fid%2FOIP.5bUEWW-Y2MPurqNVUIm-hQHaE6%3Fpid%3DApi&f=1&ipt=5080027a2f3829df7bd60e1343b4330d3b7b29880baf8fd168563159da89ffcc&ipo=images", alt: "Diseño Moderno" },
...
/**
 * Inicializa la animación de Scroll para los Filtros
 */
...
/**
 * Aplica los filtros de categoría y búsqueda al listado de productos.
 */
...
/**
 * Inicializa el listener para la búsqueda en tiempo real.
 */
    ...
    detailContent.innerHTML = `
        <div class="detail__container">
            ...
            <div class="detail__info-box">
                ...
                <p class="detail__description">${product.features} (Descripción extendida y detallada del producto: ${product.name}). Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
...
/**
 * ==========================================================================
 * LÓGICA DEL CARRITO DE COMPRAS Y CRÉDITO
 * ==========================================================================
 */

/**
 * Actualiza la visualización del crédito del usuario.
 */
function updateCreditDisplay() {
    ...
    if (creditElement) {
        ...
        // Reiniciar crédito si llega a cero o menos (Simulación)
        if (userCredit <= 0) {
            alert("🚨 ¡Tu crédito ha llegado a cero! Se reiniciará tu saldo inicial de $500. ¡Sigue comprando!");
            userCredit = 500.00;
            updateCreditDisplay();
        }
    }
...
function saveAndRenderCart() {
    ...
    if (cart.length === 0) {
        itemsHTML = '<p style="text-align: center; color: #6c757d; margin-top: 30px;">Tu carrito está vacío. ¡Añade productos!</p>';
    } else {
...
function checkout() {
    ...
    if (userCredit < total) {
        alert(`❌ Error de Compra: ¡Crédito insuficiente! Necesitas $${total.toFixed(2)} y solo tienes $${userCredit.toFixed(2)}.`);
        return;
    }
    ...
    alert(`✅ ¡Compra simulada con éxito! Se ha debitado $${total.toFixed(2)} de tu crédito. Te quedan $${userCredit.toFixed(2)}.`);
    toggleCart();
}

/**
 * ==========================================================================
 * LÓGICA DE ADMINISTRACIÓN (Solo para el Admin Panel)
 * ==========================================================================
 */
...
/**
 * Simula la eliminación de un producto (solo en el Admin Panel).
 * @param {number} productId - ID del producto a eliminar.
 */
function deleteProduct(productId) {
    if (confirm(`¿Estás seguro de eliminar el producto con ID ${productId}?`)) {
        ...
        alert("Producto eliminado. Los cambios se verán al recargar la tienda.");
    }
}

/**
 * Simula la adición de un producto (solo en el Admin Panel).
 */
function addProduct(event) {
    ...
    localStorage.setItem('products', JSON.stringify(products));
    renderAdminProductTable();
    alert(`🎉 Producto "${newProduct.name}" agregado con éxito. Actualiza la Tienda para verlo.`);
    form.reset();
}
...
function renderAdminRequests() {
    if (document.getElementById('admin-requests-container')) {
        ...
        // Actualizar estadísticas de encargos
...
/**
 * ==========================================================================
 * INICIALIZACIÓN GENERAL (Se ejecuta al cargar index.html)
 * ==========================================================================
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Inicialización de la Tienda (index.html)
    ...
    // 3. Inicialización del Admin Panel (admin.html)
    if (document.getElementById('admin-login-form')) {
        initializeAdminLogin();
        // El resto de la lógica del admin se carga tras el login exitoso
    }

});

// ==========================================================================
// LÓGICA DE LOGIN DEL ADMIN (para admin.html)
// ==========================================================================
...
function handleAdminLogin(event) {
    ...
    if (username === 'admin' && password === 'admin') {
        ...
        window.location.reload(); // Recarga la página para mostrar el contenido
    } else {
